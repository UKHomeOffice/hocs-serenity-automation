Feature: HOCS User is able to draft a response
  ...
  @InitialDraft @HOCS-287, @HOCS-239
  ...
  @InitialDraft @HOCS-288, @HOCS-239
  ...
  @InitialDraft @HOCS-296, @HOCS-239
  ...
  @InitialDraft @HOCS-297, @HOCS-298, @HOCS-239
  ...
  @InitialDraft @Validation @ScreenNotAvailableInDTEN
