...
Feature: Prioritisation
  ...
  @POGRRegression
  Scenario: User checks that a POGR case received before another is given higher priority in Registration workstack
    ...
    And I create a single "POGR" case with the correspondence received date set 5 workdays ago
    And I record the case reference of this "Newer" case
    When I click to view the "HMPO/GRO Registration" workstack
