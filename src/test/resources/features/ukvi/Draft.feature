...
Feature: Drafting
  ...
  Scenario: User should be on the UKVI Draft Page
    When I create a "UKVI" case and move it to the "Draft" stage
  ...
  Scenario: User moves a draft case to dispatch bypassing QA
    When I create a UKVI case  with "UKVI" as the Business Area and "B:Ref" as the Reference Type and move it to the "Draft" stage
    And I load and claim the current case
