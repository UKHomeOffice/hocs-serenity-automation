...
public class LoginStepDefs extends BasePage {
    ...
    private boolean loggedInAsTargetUser() {
        ...
        if (targetUser == DCU_USER | targetUser == MPAM_USER | targetUser == DECS_USER | targetUser == WCS_USER | targetUser == COMP_USER  | targetUser == WCS_USER | targetUser == FOI_USER | targetUser == IEDET_USER | targetUser == BF_USER | targetUser == TO_USER | targetUser == POGR_USER) {
