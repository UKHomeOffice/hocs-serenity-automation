...
import com.hocs.test.pages.ukvi.AccordionUKVI;
...
public class TriageStepDefs extends BasePage {
    ...
    public void theSelectedEquirySubjectAndReasonShouldBeDisplayedOnTheUKVITriagePage() {
    ...
    public void iChangeTheBusinessUnitOfTheCase(String businessArea) {
        safeClickOn(accordionUKVI.caseDetailsAccordionButton);
