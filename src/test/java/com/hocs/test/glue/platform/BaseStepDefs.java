...
import com.hocs.test.pages.platform.PeopleTab;
...
public class BaseStepDefs extends BasePage {
    ...
    public void theClaimShouldBeReturnedToTheCaseworkTeamThatLastWorkedTheClaim() {
        dashboard.getCurrentCase();
        summaryTab.selectSummaryTab();
        summaryTab.assertSummaryContainsExpectedContentForGivenHeader("Team", sessionVariableCalled("selectedCaseworkTeam"));
    }
