...
public class InitialDraft_RecordCorrespondentDetails extends BasePage {
    ...
    public void clickAdditionalCorrespondentYes() {
        safeClickOn(additionalCorrespondentYesRadioButton);
    }

    public void selectAddACorrespondent() {
        safeClickOn(addACorrespondentButton);
    }

    public void selectNotMPRadioButton() {
        safeClickOn(correspondentNotMPRadioButton);
    }
    ...
    public void addAMemberOfParliamentCorrespondent(String member) {
        safeClickOn(memberDropdownInitialize);
